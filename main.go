...
func main() {
	remoteAPIURL := []string{
		"https://cedarhospitality.com/chemical-datasheets/",
		"https://cedarhospitality.com/cedar-datasheets/",
	} // URL to fetch HTML content from
	localFilePath := "cedarhospitality.html" // Path where HTML file will be stored
	...
	for _, urls := range finalList {
		if !hasDomain(urls) {
			urls = "https://cedarhospitality.com" + urls
